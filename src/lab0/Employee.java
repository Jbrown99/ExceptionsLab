...
public class Employee {
     ...
     * @param daysVacation - a value greater than or equal to 0 but no more than 30
     */
    ...
    public final void setFirstName(String firstName) {
       if(firstName == null || firstName.length()> 100)
           throw new IllegalArgumentException("first name cannot be null and cannot be greater than 100 characters");
